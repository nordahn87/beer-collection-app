...
const SideBar = (props) => {
    ...
    return (
        <>
            <section
                className={(props.sidebar ? 'right-0' : 'right-[-100vw] md:right-[-50vw]') + ' fixed bg-white h-full top-0 w-[100vw] md:w-[50vw] transition-all p-12 z-50'}>
                <button
            ...
            <span className={(props.sidebar ? 'opacity-50' : 'hidden') + ' fixed top-0 left-0 bg-black w-screen h-screen transition-all'}></span>
        </>
    )
}
